...
def get_session_log_dir(session_id):
    ...
    """
    # Get the project root by going up from the hook's location
    hook_path = Path(__file__).resolve()
    project_root = hook_path.parent.parent.parent  # .claude/hooks/script.py -> project root
...
def main():
    try:
        ...
        log_path = session_log_dir / 'pre_tool_use.json'
