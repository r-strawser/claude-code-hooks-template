...
def main():
    try:
        ...
        session_log_dir = project_root / 'logs' / 'sessions' / session_id
        session_log_dir.mkdir(parents=True, exist_ok=True)
        
        # Update last-activity timestamp
        activity_file = session_log_dir / 'last-activity'
        activity_file.write_text(datetime.now().isoformat())
        
        log_path = session_log_dir / 'subagent_stop.json'
        ...
        if args.chat and 'transcript_path' in input_data:
            ...
            if os.path.exists(transcript_path):
                ...
                try:
                    ...
                    chat_file = session_log_dir / 'chat.json'
